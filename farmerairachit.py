...
#     },
#     # ... (keeping your existing schemes_data as is)
#     {
#         "id": "soil-health-card",
...
#     },
#     # ... (keeping your existing legal_rights_data as is)
#     {
#         "id": "water-rights",
#         "title": "Water Rights",
...
#     # ... (keeping your entire class implementation as is)
#     def __init__(self):
...
#         threshold = 0.5
#         relevant_schemes = []
#         for i, score in enumerate(scheme_similarities):
#             if score > threshold:
#                 scheme = self.schemes_df.iloc[i].to_dict()
#                 relevant_schemes.append(scheme)
#         relevant_rights = []
#         for i, score in enumerate(rights_similarities):
#             if score > threshold:
#                 right = self.rights_df.iloc[i].to_dict()
